...
const createMainWindow = async () => {
  ...
  createdWindow.webContents.on('context-menu', (_event, params) => {
    if (!isTextEntryContextMenuTarget(params) || createdWindow.isDestroyed() || createdWindow.webContents.isDestroyed()) {
      return;
    }
    ...
    try {
      ...
      // The originating frame can detach before the native menu opens.
    }
  });
